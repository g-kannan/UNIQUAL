...
def initialize_health_client(aws_access_key, aws_secret_key, region):
    ...
    try:
        ...
        raise ValueError(f"Failed to connect to AWS Health service: {e}") from e

def initialize_ses_client(aws_access_key, aws_secret_key, region):
    """
    Initialize the AWS Health client and verify the connection.
    ...
    try:
        ...
        print("Successfully connected to AWS SES service.")
        ...
        raise ValueError(f"Failed to connect to AWS SES service: {e}") from e
...
def initialize_s3_client(aws_access_key, aws_secret_key, region):
    ...
    try:
        ...
        raise ValueError(f"Failed to connect to AWS S3 service: {e}") from e
